Gem::Specification.new do |spec|
  ...
  spec.summary       = 'A modern, highly customizable, and responsive Jekyll theme for documentation with built-in search.'
  ...
  spec.files = `git ls-files -z ':!:*.jpg' ':!:*.png'`.split("\x0").select do |f|
    f.match(/^(assets|bin|_layouts|_includes|lib|Rakefile|_sass|LICENSE|README|CHANGELOG|favicon)/i)
  end
