# -*- encoding: utf-8 -*-
# stub: pdf-reader 2.12.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/yob/pdf-reader/issues", "changelog_uri" => "https://github.com/yob/pdf-reader/blob/v2.12.0/CHANGELOG", "documentation_uri" => "https://www.rubydoc.info/gems/pdf-reader/2.12.0", "source_code_uri" => "https://github.com/yob/pdf-reader/tree/v2.12.0" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<Ascii85>.freeze, ["~> 1.0".freeze])
